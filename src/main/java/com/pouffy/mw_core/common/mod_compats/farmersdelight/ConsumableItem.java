...
import com.pouffy.mw_core.mw_capsules.TextUtils;
...
{
    //Code borrowed from Vectorwing to avoid having multiple dependencies
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag isAdvanced) {
        if (MWClientConfig.FOOD_EFFECT_TOOLTIP.get()) {
