...
public class Kermitamine {
    ...
    public static final RegistryObject<FlowingFluid> LIQUID_KERMITAMINE_FLOWING
            = KERMIT_FLUIDS.register("liquid_kermitamine_flowing", () -> new ForgeFlowingFluid.Flowing(Kermitamine.LIQUID_KERMITAMINE_PROPERTIES));
    ...
    public static final ForgeFlowingFluid.Properties LIQUID_KERMITAMINE_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .block(Kermitamine.LIQUID_KERMITAMINE_BLOCK).bucket(Kermitamine.KERMITAMINE_CRYSTAL_ALPHA);

    public static final RegistryObject<LiquidBlock> LIQUID_KERMITAMINE_BLOCK = Kermitamine.KERMIT_BLOCKS.register("liquid_kermitamine",
