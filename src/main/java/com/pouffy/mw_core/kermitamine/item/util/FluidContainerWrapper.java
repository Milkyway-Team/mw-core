package com.pouffy.mw_core.kermitamine.item.util;
...
public class FluidContainerWrapper implements IFluidHandlerItem, ICapabilityProvider
{
    ...
    public FluidContainerWrapper(@Nonnull ItemStack container)
    {
    ...
    public FluidStack getFluid()
    {
        ...
        {
            return new FluidStack(((ContainerItem)item).getFluid(), FluidAttributes.BUCKET_VOLUME);
        }
    ...
    protected void setFluid(@Nonnull FluidStack fluidStack)
    {
        if (fluidStack.isEmpty())
            container = new ItemStack(Kermitamine.CONTAINER.get());
        else
